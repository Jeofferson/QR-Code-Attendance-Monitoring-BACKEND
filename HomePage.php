...
<head>
	...
	<title>PHINMA University of Pangasinan -Student List</title>
...
<body style="margin: 0px;" background="images/bg.png">
	...
	<div id="divButtons" class="form-group">
		...
		<button type="button" class="button button2 modalAdd" data-toggle="modal" data-target="#user_modal" style=" margin-top: 40px;">Add Student</button>
			...
			<div class="modal-content">
				...
				<form method="POST" enctype="multipart/form-data" action="process.php">
					<div class="modal-body">
						<input type="file" name="csv_file_student" placeholder="Import" class="btn btn-info btn-block">		
					</div>
					<div class="modal-footer">
						<button class="btn btn-danger" data-dismiss="modal">Close</button>
						<input type="submit" name="upload_csv_file_student" value="Upload" class="btn btn-success">
					</div>
				</form>
			</div>
		</div>
	...
	<div class="modal fade" role="dialog" id="user_modal">	
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title modalTitle">Add Student</h3>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					<form method="POST" name="form" action="process.php"> 
						<div class="form-group">
							<label class="lbl-add">Student ID</label>
							<input id="field" type="text" name="studentId" class="form-control modalField1" required="true"  value="" autocomplete="off">
							...
							<label class="lbl-add">Course</label>
							<input id="field" type="text" name="course" class="form-control modalField5" required="true" autocomplete="off">
							<input style="position:absolute; opacity:0; top:-10000px" id="field" type="text" name="id" class="form-control modalField6" required="true" autocomplete="off"  value="null" >
							<!-- <select id="Courses" class="form-control modalField5" name="course">
								<option value="none">
									--Select--
								</option>
								<option>
						...
						<div class="form-group">
							<input type="submit" name="add_student" value="Create" class="btn btn-success form-control modalButtonSubmit">
						</div>
					</form>
				</div>
				<div class="modal-footer">
	...
	<div class="container">
		...
		<?php
			...
			$result = $mysqli->query("SELECT * FROM tbl_student") or die($mysqli->error);
		?>
			...
			<tbody id="tbody">
				<tr>
					...
					<td class="text" data-id="<?php echo $row["id"]; ?>"> 
						...
						<a href="#">
							<img src="images/edit.png" class="option1 modalEdit" data-toggle="modal" data-target="#user_modal" data-id="<?php echo $row["id"]; ?>">
						</a>
						<a onclick="deleteMe(<?php echo $row['id'] ?>)" href="process.php?delete_student=<?php echo $row['id']; ?>">
